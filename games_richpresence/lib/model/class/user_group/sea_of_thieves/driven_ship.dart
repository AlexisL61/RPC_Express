...
class SeaOfThievesDrivenShip extends Ship {
  final int players;

  SeaOfThievesDrivenShip(
      {required String name, required SeaOfThievesShipType type, required String icon, required this.players, required int maxPlayers})
